  ...
  return (
    <section className={styles.aboutSection}>
      ...
      <Typography variant="p1" color="invert" className={styles.description}>
        24-часовой офлайн марафон программирования, направленный на решение
        кейсов, прокачку скиллов и командную работу. Не упусти возможность
        создать крутой проект и выиграть стажировку!
      </Typography>
